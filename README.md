...
В третій частині практичної роботи було реалізовано знаходження опорного та оптимального розв'язків (за їх наявності) матриці за допомогою модифікованих Жорданових виключень, а також знаходження максимуму або мінімуму цільової функції, при умові наявності рівностей (нульових рядків). Для цього алгоритм частини B було змінено. В алгоритм, перед основною частиною знаходження розв'язків, було додано алгоритм перенесення нульових рядків нагору в результаті виконання МЖВ, на місце X-ів, а також видалення нульових стовпців. Для коректного вводу симплекс-таблиці, при вводі рядка з рівністю, знаки кожного елементів рівня
