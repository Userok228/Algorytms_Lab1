...
![Lab1A_Variant18_img](images/Lab1A_Variant18.png)
...
![Lab1B_Variant18_img](images/Lab1B_Variant18.png)

## Виконання  частини C практичної роботи
В третій частині практичної роботи було реалізовано знаходження опорного та оптимального розв'язків (за їх наявності) матриці за допомогою модифікованих Жорданових виключень, а також знаходження максимуму або мінімуму цільової функції, при умові наявності рівностей (нульових рядків). Для цього алгоритм частини B було змінено. В алгоритм, перед основною частиною знаходження розв'язків, було додано алгоритм перенесення нульових рядків нагору в результаті виконання МЖВ, на місце X-ів, а також видалення отриманих нульових стовпців. Для коректного вводу рядка з рівністю - потрібно лише змінити знак елемента, що ввійде до одинарного стовпчика (в результаті перенесення елемента в ліву сторону рівності). 

Далі було реалізовано виключення вільних змінних. Для цього було створено класи видаленого рядка та елемента видаленого рядка. Клас рядка містить в собі індекс, що характеризує видалений Х, масив об'єктів класу елементів, а також обчислюване значення, яке використовується для пошуку X-ів у формулах в які воно входить. 
...
Приклад роботи програми за умови наявності нульових рядків:

![Lab1C_Variant18_img](images/Lab1C_Variant18.png)

Приклад роботи програми за умови наявності вільних змінних:

![Lab1C_Variant18_img](images/Lab1C_FreeX.png)
